...
print (f"The total amount of loans is {total_loan_amount}.")
...
def new_loan_pv (new_loan_fv, new_loan_remaining_months, annual_discount_rate):
    present_value = new_loan_fv / (1 + annual_discount_rate/12) ** 12
    print(f"The present value of the loan is: {present_value}")


# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
new_loan_pv (1000, 12, 0.2)
